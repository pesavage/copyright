...
setwd("/Users/pesavage/Documents/Research/Papers/Published/Savage et al. (2018) FMA Music copyright infringement analysis")
...
copy<-read.csv("20CopyrighCaseSequences.csv",header=FALSE)
